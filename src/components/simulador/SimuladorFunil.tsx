...
export default function SimuladorFunil({ outputs }: SimuladorFunilProps) {
  ...
  const stages: FunnelStage[] = [
    ...
    { label: 'Aplicacoes', value: outputs.aplicacoes, width: '70%', color: 'bg-primary/90' },
    { label: 'Agendamentos', value: outputs.agendamentos, width: '50%', color: 'bg-primary/80' },
    { label: 'Entrevistas', value: outputs.entrevistas, width: '35%', color: 'bg-primary/70' },
    { label: 'Vendas Formacao', value: outputs.vendasFormacao, width: '22%', color: 'bg-emerald-500' },
  ];
