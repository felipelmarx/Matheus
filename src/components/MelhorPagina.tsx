      ...
      <div className="p-6">
        <div className="flex items-start gap-4">
          <div className="flex-1">
            <p className="text-sm text-muted-foreground font-heading mb-2">Link da página</p>
          ...
          <div className="flex items-center gap-2 bg-muted/30 rounded-lg px-4 py-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground font-heading">Conversão Checkout</p>
